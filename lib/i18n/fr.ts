...
export const fr = {
  ...
  installer: {
    ...
    vignette: {
      ...
      botReply:
        "Un zip WordPress. Gratuit, sans carte. Vous le déposez dans WP-Admin — la bulle apparaît.",
      ...
      liveHost: "votre-site.fr",
      liveTitle: "Votre site",
      liveBody: "La bulle Talker est en bas à droite.",
      wpScreen: "Extensions",
      wpAdd: "Ajouter",
