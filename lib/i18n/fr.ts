    ...
    items: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Conversation calée sur des cadres prouvés : persuasion (Cialdini), vente consultative (SPIN Selling) et négociation (Chris Voss) — clarifier le besoin, appuyer la preuve, proposer le prochain pas ; pas un script commercial générique",
