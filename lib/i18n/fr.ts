    ...
    items: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "E-mail toutes les 4 h avec le détail des conversations (rien s'il n'y a rien)",
          "SMS possible aux seuils 50 / 75 / 90 (si mobile renseigné)",
          "Montre ce que les visiteurs demandent vraiment — pas un résumé marketing",
        ],
        visual: "collab",
      },
      {
