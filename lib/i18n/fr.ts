    ...
    items: [
      {
        ...
        bullets: [
          ...
          "Répond sur tarifs, options et modalités quand ils figurent sur vos pages",
          "Adopte le ton de votre marque ; refuse le style « réponse IA » formatée",
          "S'adapte au métier sans menu de secteurs à cocher (cabinet, artisan, conseil, culture…)",
        ],
        visual: "ai",
      },
      {
        ...
        bullets: [
          "Pose les questions d'un commercial senior : besoin d'abord, proposition ensuite",
          "Cadres citables : persuasion (Cialdini), vente consultative (SPIN Selling), négociation / reformulation (Chris Voss)",
          ...
          "Vous recevez par e-mail, toutes les 4 heures, les échanges s'il y en a eu (rien si aucune conversation)",
          "Alerte SMS possible si un numéro mobile est renseigné (seuils 50 / 75 / 90 conversations sur le plan gratuit)",
          "Vous voyez ce que les visiteurs demandent vraiment sur votre site — pas un résumé marketing",
          "Conversation calée sur des leviers prouvés de persuasion (Cialdini) : clarifier le besoin, appuyer la preuve, proposer le prochain pas — pas un script commercial générique",
        ],
        visual: "collab",
      },
      {
        ...
        bullets: [
          "Fait préciser la situation avant un humain",
          "Recueille un créneau de rappel (connexion agenda / Calendar possible)",
          "Distingue prospect à convertir et client déjà en portefeuille",
          "Transmet un dossier cadré, prêt à traiter",
        ],
        visual: "security",
      },
    ],
