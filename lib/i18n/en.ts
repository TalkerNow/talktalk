    ...
    items: [
      {
        ...
        bullets: [
          ...
          "Answers on prices, options, and terms when they appear on your pages",
          "Takes your brand voice; refuses the formatted \"AI reply\" style",
          "Fits the trade without a sector menu to tick (practice, craft, consulting, culture…)",
        ],
        visual: "ai",
      },
      {
        ...
        bullets: [
          "Asks the questions a senior salesperson would: need first, offer after",
          "Citable frames: persuasion (Cialdini), consultative selling (SPIN Selling), negotiation / reformulation (Chris Voss)",
          ...
          "You get an email every 4 hours with the exchanges if any took place (nothing if there was no conversation)",
          "Optional SMS alert if a mobile number is on file (thresholds 50 / 75 / 90 conversations on the free plan)",
          "You see what visitors actually ask for on your site — not a marketing summary",
          "Conversation set on proven persuasion levers (Cialdini): clarify the need, back the proof, propose the next step — not a generic sales script",
        ],
        visual: "collab",
      },
      {
        ...
        bullets: [
          "Gets the situation clear before a human steps in",
          "Collects a callback slot (calendar / Calendar connection possible)",
          "Separates a prospect to convert from a client already on the books",
          "Hands over a framed brief, ready to handle",
        ],
        visual: "security",
      },
    ],
