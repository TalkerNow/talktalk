    ...
    items: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Conversation set on proven frames: persuasion (Cialdini), consultative selling (SPIN Selling), and negotiation (Chris Voss) — clarify the need, back the proof, propose the next step; not a generic sales script",
